      ...
      <div className=' flex items-center justify-between w-[88%] mx-auto'>
        ...
        <div className='mx-6'>
          <ul className='space-x-6 hidden md:flex '>
            ...
            <Link className='hover:text-blue-700 font-semibold' to='/blogs'>BLOGS</Link>
            <Link className='hover:text-blue-700 font-semibold' to='/creators'>CREATORS</Link>
            <Link className='hover:text-blue-700 font-semibold' to='/about'>ABOUT</Link>
            <Link className='hover:text-blue-700 font-semibold' to='/contact'>CONTACT</Link>
          </ul>
