          ...
          <div className=' hover:shadow-xl  rounded-xl w-full flex flex-col md:flex-row justify-start mt-10 bg-white' >
            <div className='bg-black text-white md:w-[40%] border-2 border-black rounded-xl p-4 space-y-4'>
              ...
              <div className='space-y-3'>
                <p className='flex gap-6'><span><MdWifiCalling1 size={30} /></span> +91 93801XXXXX</p>
                <p className='flex gap-6'><span><AiFillMessage size={30} /></span>  sainathdev@gmail.com</p>
                <p className='flex gap-6'><span><MdOutlineLocationOn size={30} /></span> Belagavi, Karnataka, India</p>
              </div>
            </div>
            <div className='md:w-[60%] p-10   ' >
              <form onSubmit={handleSubmit(onSubmit)} className='space-y-4'>
                <div>
                  ...
                  />
                  {errors.username && <span className='text-sm font-semibold text-red-500'>This field is required</span>}
